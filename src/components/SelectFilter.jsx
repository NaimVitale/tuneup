...
function SelectFilter({ nombreCategoria }) {
    return (
        <div className="relative">
            <select name="" id={nombreCategoria} className='rounded-3xl py-2 px-5 border-black border-1 color-primary text-center text-white font-medium text-xl w-full appearance-none'>
