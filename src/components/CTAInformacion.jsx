...
export default function CTAinformacion(){
    return(
        <div className="relative bg-no-repeat bg-center bg-cover text-white py-12 bg-[#C122ED]" style={{ backgroundImage: `url(${HeroImage})` }}>
            <div className="absolute inset-0 bg-[#C122ED] opacity-40 mix-blend-multiply z-0"></div>
            <div className='relative w-[90%] m-auto flex flex-col items-center'>
                <h2 className='text-6xl mb-4 text-medium'>¡No te pierdas ningún concierto!</h2>
                ...
                <button className='btn-primary py-2 px-6 text-xl mt-4'>Quiero estar informado</button>
            </div>
        </div>
    )
}